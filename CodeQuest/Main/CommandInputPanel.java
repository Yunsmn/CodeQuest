...
/**
 * CommandInputPanel - Python-Style Command Input
 */
public class CommandInputPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        // Add text change listener to cycle hints
        ...
        pythonLabel.setForeground(new Color(86, 156, 214)); // Python blue
    ...
    private void executeCommand() {
        ...
        // Display command in Python style
    ...
    private void appendOutput(String text) {
        ...
        // Limit output area to last 100 lines
    ...
    /**
     * Call this periodically to update the queue counter
     */
